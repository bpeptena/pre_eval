...
-- PURPOSE:
--
--    Transforms the VGA signals into DVI signals using 3 TMDS encoders
--    and 4 OSERDES2 serializers.
...
BEGIN
  ...
  oserdes_tx0_inst : ENTITY work.oserdes_ddr_10_1
      PORT MAP( clk_i     => sclk_i,
                clk_x5_i  => sclk_x5_i,
                arst_i    => arst_i,
                pdata_i   => tmds_x(0), -- output from TMDS for red
  ...
  oserdes_tx1_inst : ENTITY work.oserdes_ddr_10_1
    port map(
      ...
      clk_x5_i  => sclk_x5_i,
      arst_i    => arst_i,
      pdata_i   => tmds_x(1), -- output from TMDS for green
  ...
  oserdes_tx2_inst : ENTITY work.oserdes_ddr_10_1
      PORT MAP( clk_i     => sclk_i,
                clk_x5_i  => sclk_x5_i,
                arst_i    => arst_i,
                pdata_i   => tmds_x(2),  -- output from TMDS for blue
