...
--    Encodes 8 bits of data into 10 to reduce electormagnetic interference
--    over copper cables and enables robust clock recovery by minimizing the
...
BEGIN
  ...
  -- Calculate the difference between the number of ones (n1) 
  -- and number of zeros (n0) in the encoded symbol
